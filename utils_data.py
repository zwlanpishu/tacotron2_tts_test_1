...
from utils_public import load_wav_to_torch, load_filepaths_and_text
...
class TextMelLoader(torch.utils.data.Dataset):
    ...
    def get_mel_text_pair(self, audiopath_and_text):
        ...
        if not self.load_mel_from_disk:
            audiopath = os.path.join(self.dump, audiopath + ".wav")
        else:
            audiopath = os.path.join(self.dump, audiopath + ".norm.npy")
    ...
    def get_text(self, text):
        ...
        text_norm = torch.IntTensor(np.array(tokens))
        return text_norm
