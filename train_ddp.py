...
def load_model(hparams, gpu_rank):
    model = Tacotron2(hparams).cuda(gpu_rank)
...
def validate(model, criterion, valid_loader):
    ...
    model.train()
    return (val_sum, val_mel_l1, val_mel_l2, val_gate)
...
def main(gpu_rank, args):
    ...
    criterion = Tacotron2Loss().cuda(gpu_rank)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--output_directory",
        type=str,
        default="/home/server/disk1/checkpoints/tacotron2_tts/baseline_noamp",
    ...
    parser.add_argument(
        ...
        "--log_directory",
        type=str,
        default="/home/server/disk1/checkpoints/tacotron2_tts/log/baseline_noamp",
